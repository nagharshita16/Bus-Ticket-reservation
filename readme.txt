...
int main()              // Contain 4 cases New user, existing user, About us and exit.
{
    ...
    while(b)
    {
        ...
        case 1:                     //Not using break so that user can directly go to user login.
        {
            ...
            user_gen();
            printf("\n\nRedirecting to User login.**Please Wait**\n");
            Sleep(3000);
        }
        case 2:
        {
...
int travel()
{
    int i,tno,ag[30];//i will be used as for loop counter to print the ticket
...
again://if gender or username is wrong, control comes here
        ...
        {
            printf("Wrong paseenger information\n");
            printf("Re-directing you...please wait!***\n");
            Sleep(1000);
        goto again;
        }
        }
...
goto seat;}
    ...
    printf("Thankyou for using our bus reservation system. Visit Again!\n");
    Sleep(6000);
    exit(0);
}
else
